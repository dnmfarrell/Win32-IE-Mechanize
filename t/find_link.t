...
plan $^O =~ /MSWin32|cygwin/i 
    ? (tests => 58) : (skip_all => "This is not MSWin32!");
...
is scalar @all_links1, 15,  "Returned all links (15)";
is scalar @$all_links2, 15, "Returned all links from scalar context";
...
$x = $t->find_link( tag_regex => qr/^(a|frame)$/i, n => 5 );
isa_ok( $x, 'Win32::IE::Link' );
